public class Loan {
    ...
    public Loan(double annualInterestRate, int numberOfYears, double loanAmount) throws IllegalArgumentException {
        ...
        if (annualInterestRate <= 0) {
            throw new IllegalArgumentException("Годовая процентная ставка не может быть меньше нуля или равной ему!");
        }
        if (numberOfYears <= 0) {
            throw new IllegalArgumentException("Количество лет не может быть меньше нуля или равной ему!");
        }
        if (loanAmount <= 0) {
            throw new IllegalArgumentException("Сумма кредита не может быть меньше нуля или равной ему!");
        }
